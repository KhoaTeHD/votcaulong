        ...
        <div class="col-md-12">
            <section class="my-3 shadow-sm border border-light bg-white">
                <div class="section-header bg-none">
                    <h3 class="title">Hướng dẫn tổng hợp</h3>
                </div>
                <div class="row p-3">
                    <div class="col-md-9">
                        ...
                        <div class="row my-3">
                            <?php
                            $args = array(
                                'category_name'  => 'guide', // Thay bằng slug của category bạn muốn lấy
                    ...
                    <div class="col-md-3">
                        <div class="link-title">
                            <h5>Tin tức review</h5>
                            <a href="#">Xem thêm</a>
                        </div>
                        <div class="row my-3 review-posts post-listing">
                        <?php
                            $args = array(
                                'category_name'  => 'review', // Nếu có category "review"
                                'posts_per_page' => 3,
                            );
                    ...
                    $posts_per_page = 5;
                    $args = array(
                        'category_name' => 'guide', // Slug của category cần đếm
